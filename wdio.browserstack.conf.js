...
export const config = {
  ...
  baseUrl: `https://fcp-mpdp-journey-test-suite.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `fcp-mpdp-journey-test-suite-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `fcp-mpdp-journey-test-suite-${process.env.ENVIRONMENT}`
        },
